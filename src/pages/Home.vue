...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(4rem, 14vw, 16rem)), 60rem); min-height: min(29rem, calc(100svh - 14rem)); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, .96); border-radius: clamp(1.6rem, 2.6vw, 2.5rem); outline: 1px solid rgba(255, 255, 255, .48); outline-offset: .34rem; background: linear-gradient(135deg, rgba(255, 255, 255, .82), rgba(255, 255, 255, .3) 58%, rgba(255, 237, 247, .34)); box-shadow: inset 0 1.2px 0 rgba(255, 255, 255, 1), inset 0 -1px 0 rgba(92, 12, 72, .12), inset 1rem 1.25rem 2.5rem rgba(255, 255, 255, .5), inset -1rem -1.25rem 2.5rem rgba(92, 12, 72, .08), 0 .34rem .55rem rgba(255, 255, 255, .82), 0 1.4rem 2.3rem rgba(91, 25, 15, .13), 0 2.8rem 5rem rgba(91, 25, 15, .1); backdrop-filter: blur(1.5rem) saturate(1.2); -webkit-backdrop-filter: blur(1.5rem) saturate(1.2); transform: perspective(90rem) rotateX(.45deg); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 10% 4%, rgba(255, 255, 255, .98), transparent 23%), radial-gradient(circle at 8% 20%, rgba(217, 74, 18, .14), transparent 30%), radial-gradient(circle at 92% 12%, rgba(237, 22, 114, .16), transparent 32%), radial-gradient(circle at 76% 96%, rgba(92, 12, 72, .13), transparent 38%), linear-gradient(112deg, rgba(255, 255, 255, .6), transparent 24%, transparent 66%, rgba(255, 255, 255, .14)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 18%; bottom: -25%; left: 18%; height: 34%; border: 1px solid rgba(255, 255, 255, .34); border-radius: 50%; background: linear-gradient(90deg, rgba(217, 74, 18, .14), rgba(194, 11, 90, .22), rgba(92, 12, 72, .14)); content: ''; filter: blur(1.55rem); pointer-events: none; }
