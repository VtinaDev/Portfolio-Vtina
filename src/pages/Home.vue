...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(2rem, 7vw, 7rem)), 78rem); min-height: calc(100svh - 8rem); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, .88); border-radius: clamp(1.75rem, 3vw, 3rem); background: linear-gradient(135deg, rgba(255, 255, 255, .72), rgba(255, 255, 255, .34)); box-shadow: inset 0 1px 0 rgba(255, 255, 255, .96), inset 0 -1px 0 rgba(92, 12, 72, .12), inset 1.2rem 1.35rem 2.8rem rgba(255, 255, 255, .34), inset -1.2rem -1.35rem 2.8rem rgba(92, 12, 72, .08), 0 .7rem 0 rgba(255, 255, 255, .74), 0 1.7rem 3.6rem rgba(91, 25, 15, .16); backdrop-filter: blur(1.1rem) saturate(1.12); -webkit-backdrop-filter: blur(1.1rem) saturate(1.12); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(circle at 10% 10%, rgba(217, 74, 18, .18), transparent 27%), radial-gradient(circle at 88% 17%, rgba(237, 22, 114, .16), transparent 30%), radial-gradient(circle at 74% 94%, rgba(92, 12, 72, .15), transparent 35%), linear-gradient(125deg, rgba(255, 255, 255, .42), transparent 38%, rgba(255, 255, 255, .08)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 14%; bottom: -24%; left: 14%; height: 31%; border-radius: 50%; background: linear-gradient(90deg, rgba(217, 74, 18, .14), rgba(194, 11, 90, .22), rgba(92, 12, 72, .16)); content: ''; filter: blur(2rem); pointer-events: none; }
