...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(4rem, 12vw, 12rem)), 38rem); min-height: min(22rem, calc(100svh - 18rem)); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, 1); border-radius: clamp(1.8rem, 3vw, 2.7rem); outline: .32rem solid rgba(255, 255, 255, .62); outline-offset: .06rem; background: linear-gradient(145deg, rgba(255, 255, 255, .98), rgba(226, 237, 255, .7) 51%, rgba(250, 229, 246, .6)); box-shadow: inset 0 2px 1px rgba(255, 255, 255, 1), inset 0 -4px 3px rgba(58, 80, 141, .16), inset 1.25rem 1.45rem 2.8rem rgba(255, 255, 255, .94), inset -1.35rem -1.55rem 3.2rem rgba(94, 63, 153, .12), 0 .2rem .35rem rgba(255, 255, 255, 1), 0 .6rem .8rem rgba(104, 117, 183, .25), 0 1.55rem 2.4rem rgba(69, 42, 113, .18), 0 2.8rem 5rem rgba(91, 25, 15, .14); backdrop-filter: blur(2.3rem) saturate(1.28) brightness(1.06); -webkit-backdrop-filter: blur(2.3rem) saturate(1.28) brightness(1.06); transform: perspective(80rem) rotateX(.25deg); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 18% -3%, rgba(255, 255, 255, 1) 0 16%, transparent 35%), radial-gradient(ellipse at 2% 49%, rgba(255, 255, 255, .94), transparent 27%), radial-gradient(ellipse at 97% 4%, rgba(135, 209, 255, .57), transparent 27%), radial-gradient(ellipse at 90% 98%, rgba(255, 125, 207, .24), transparent 32%), linear-gradient(110deg, rgba(255, 255, 255, .92) 0 6%, rgba(255, 255, 255, .22) 17%, transparent 29% 63%, rgba(165, 213, 255, .13) 73%, rgba(255, 255, 255, .62) 87%, rgba(255, 255, 255, .94) 100%); content: ''; mix-blend-mode: screen; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 7%; bottom: -29%; left: 7%; height: 48%; border: 2px solid rgba(255, 255, 255, .9); border-radius: 50%; background: linear-gradient(90deg, rgba(105, 205, 255, .24), rgba(255, 255, 255, .82) 45%, rgba(230, 80, 184, .23)); box-shadow: 0 -1.15rem 1.8rem rgba(255, 255, 255, .76), inset 0 .25rem .7rem rgba(255, 255, 255, .75); content: ''; filter: blur(.85rem); pointer-events: none; }
