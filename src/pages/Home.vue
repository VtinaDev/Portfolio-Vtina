...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(1rem, 3vw, 3rem)), 82rem); min-height: calc(100svh - 6.5rem); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, .92); border-radius: clamp(1.75rem, 3vw, 3rem); outline: 1px solid rgba(255, 255, 255, .36); outline-offset: .26rem; background: linear-gradient(135deg, rgba(255, 255, 255, .78), rgba(255, 255, 255, .32)); box-shadow: inset 0 1px 0 rgba(255, 255, 255, .98), inset 0 -1px 0 rgba(92, 12, 72, .14), inset 1.2rem 1.35rem 2.8rem rgba(255, 255, 255, .42), inset -1.2rem -1.35rem 2.8rem rgba(92, 12, 72, .1), 0 .45rem 0 rgba(255, 255, 255, .78), 0 1.65rem 3.6rem rgba(91, 25, 15, .18); backdrop-filter: blur(1.2rem) saturate(1.16); -webkit-backdrop-filter: blur(1.2rem) saturate(1.16); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 8% 7%, rgba(255, 255, 255, .88), transparent 24%), radial-gradient(circle at 9% 14%, rgba(217, 74, 18, .18), transparent 28%), radial-gradient(circle at 90% 16%, rgba(237, 22, 114, .19), transparent 32%), radial-gradient(circle at 74% 94%, rgba(92, 12, 72, .16), transparent 37%), linear-gradient(118deg, rgba(255, 255, 255, .54), transparent 28%, transparent 68%, rgba(255, 255, 255, .1)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 12%; bottom: -22%; left: 12%; height: 33%; border: 1px solid rgba(255, 255, 255, .22); border-radius: 50%; background: linear-gradient(90deg, rgba(217, 74, 18, .18), rgba(194, 11, 90, .27), rgba(92, 12, 72, .18)); content: ''; filter: blur(1.8rem); pointer-events: none; }
...
.home-hero__main { position: relative; z-index: 1; align-self: center; padding: clamp(2.25rem, 4vw, 4.25rem) clamp(1.25rem, 4vw, 4rem); text-align: left; }
...
@media (max-width: 720px) { .home-hero { min-height: calc(100svh - 7rem); grid-template-columns: 1fr; padding: 0; }.glass-panel { width: calc(100% - 1rem); min-height: calc(100svh - 7.75rem); border-radius: 1.75rem; }.home-hero__main { align-self: start; padding: 5rem 1rem 1.75rem; text-align: center; }.home-hero h1, .home-hero__intro { margin-left: auto; margin-right: auto; }.home-hero h1 { max-width: 100%; text-align: center; font-size: clamp(2.3rem, 12vw, 3.8rem); }.home-hero__role { white-space: normal; }.home-hero__actions { justify-content: center; } }
