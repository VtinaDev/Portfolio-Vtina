<template>
  <LayoutBase class="home-layout">
    <section class="home-hero" aria-labelledby="home-title">
      ...
      <div class="home-hero__portrait fade-in delay-2" aria-hidden="true">
        <div class="home-hero__portrait-halo"></div>
...
import portrait from '../assets/Sujeto.png'
...
<style scoped>
:deep(.home-layout) { background: #e3e3e3; }
:deep(.home-layout main) { padding: 0; background: #dcd8d8; }
...
.home-hero { position: relative; display: grid; min-height: min(48rem, 100vh); grid-template-columns: minmax(0, 1.05fr) minmax(16rem, .95fr); overflow: hidden; padding: clamp(5.8rem, 10vw, 8rem) clamp(1.25rem, 5vw, 4.5rem) clamp(2rem, 5vw, 4.5rem); background: transparent; color: var(--brand-ink); isolation: isolate; }
...
.home-hero__portrait { position: relative; align-self: end; justify-self: center; width: min(100%, 31rem); height: min(64vh, 34rem); }
.home-hero__portrait-halo { position: absolute; right: 5%; bottom: 4%; width: 88%; aspect-ratio: 1; border-radius: 50%; background: radial-gradient(circle at 38% 35%, rgba(255, 245, 238, .96), rgba(249, 164, 205, .48) 47%, rgba(194, 11, 90, .12) 70%, transparent 71%); filter: blur(.15rem); }
.home-hero__portrait img { position: absolute; bottom: clamp(-3.25rem, -4vw, -1.25rem); left: 50%; z-index: 1; width: auto; max-width: none; height: 100%; transform: translateX(-50%); object-fit: contain; object-position: bottom center; filter: drop-shadow(.8rem 1rem 1.4rem rgba(81, 12, 38, .2)); }
...
@media (max-width: 720px) { .home-hero { min-height: 100svh; grid-template-columns: 1fr; grid-template-rows: auto minmax(16rem, 1fr); padding: 5.5rem 1.25rem 0; }.home-hero__main { align-self: start; padding: 1.5rem 0 0; text-align: center; }.home-hero h1, .home-hero__intro { margin-left: auto; margin-right: auto; }.home-hero h1 { max-width: 100%; text-align: center; font-size: clamp(2.3rem, 12vw, 3.8rem); }.home-hero__actions { justify-content: center; }.home-hero__portrait { width: min(100%, 23rem); height: min(43vh, 25rem); }.home-hero__portrait img { bottom: -1rem; }.home-hero__portrait-halo { width: 95%; } }
@media (max-width: 480px) { .home-hero { padding: 5rem 1rem 0; }.home-hero__main { padding-top: 1rem; }.home-hero h1 { font-size: clamp(2.15rem, 11.5vw, 3.2rem); line-height: 1.04; }.home-hero__intro { font-size: 1rem; }.home-hero__actions { display: grid; grid-template-columns: 1fr; width: min(100%, 18rem); margin-left: auto; margin-right: auto; }.home-hero__actions .button { justify-content: center; width: 100%; }.home-hero__portrait { height: min(39vh, 21rem); }.code-float--three, .code-float--six { display: none; } }
