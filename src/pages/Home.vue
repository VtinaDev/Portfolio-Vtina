...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(3rem, 8vw, 8rem)), 48rem); min-height: min(28rem, calc(100svh - 15rem)); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, .98); border-radius: clamp(1.8rem, 3vw, 2.7rem); outline: .24rem solid rgba(255, 255, 255, .42); outline-offset: .08rem; background: linear-gradient(145deg, rgba(255, 255, 255, .9), rgba(248, 245, 248, .54) 54%, rgba(255, 237, 247, .46)); box-shadow: inset 0 1.5px 0 rgba(255, 255, 255, 1), inset 0 -2px 0 rgba(92, 12, 72, .11), inset 1.1rem 1.4rem 2.8rem rgba(255, 255, 255, .58), inset -1.1rem -1.4rem 2.8rem rgba(92, 12, 72, .08), 0 .34rem .5rem rgba(255, 255, 255, .94), 0 .8rem 1rem rgba(92, 12, 72, .12), 0 1.9rem 3.8rem rgba(91, 25, 15, .13); backdrop-filter: blur(1.7rem) saturate(1.16); -webkit-backdrop-filter: blur(1.7rem) saturate(1.16); transform: perspective(80rem) rotateX(.35deg); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 12% 2%, rgba(255, 255, 255, 1), transparent 29%), radial-gradient(ellipse at 4% 48%, rgba(255, 255, 255, .54), transparent 22%), radial-gradient(circle at 9% 14%, rgba(217, 74, 18, .11), transparent 27%), radial-gradient(circle at 91% 13%, rgba(237, 22, 114, .13), transparent 28%), linear-gradient(118deg, rgba(255, 255, 255, .62), transparent 27%, transparent 70%, rgba(255, 255, 255, .18)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 15%; bottom: -29%; left: 15%; height: 38%; border: 1px solid rgba(255, 255, 255, .46); border-radius: 50%; background: linear-gradient(90deg, rgba(217, 74, 18, .12), rgba(194, 11, 90, .18), rgba(92, 12, 72, .12)); content: ''; filter: blur(1.4rem); pointer-events: none; }
