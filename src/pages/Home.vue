  ...
  <LayoutBase class="home-layout">
    <section class="home-hero" aria-labelledby="home-title">
      ...
      <section class="glass-panel" aria-label="Presentación de Vtina Dev">
        <div class="glass-panel__edge" aria-hidden="true"></div>
...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(3rem, 10vw, 10rem)), 34rem); min-height: min(23rem, calc(100svh - 17rem)); align-self: center; justify-self: center; overflow: hidden; border: 1.5px solid rgba(255, 255, 255, .86); border-radius: 1.75rem; outline: 1px solid rgba(201, 120, 76, .24); outline-offset: .22rem; background: linear-gradient(145deg, rgba(255, 255, 255, .67), rgba(255, 241, 232, .38) 54%, rgba(255, 255, 255, .53)); box-shadow: 0 1.25rem 2.6rem rgba(84, 46, 52, .16), 0 .42rem .62rem rgba(145, 77, 44, .16), inset 0 1px 2px rgba(255, 255, 255, .96), inset 0 -3px 7px rgba(105, 53, 27, .12), inset 1.1rem 1.1rem 2.2rem rgba(255, 255, 255, .5); backdrop-filter: blur(25px) saturate(180%); -webkit-backdrop-filter: blur(25px) saturate(180%); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: linear-gradient(112deg, rgba(255, 255, 255, .84) 0 5%, rgba(255, 255, 255, .19) 17%, transparent 31% 68%, rgba(255, 190, 143, .16) 84%, rgba(255, 255, 255, .7) 100%), radial-gradient(ellipse at 10% 0%, rgba(255, 255, 255, .88), transparent 37%), radial-gradient(ellipse at 100% 100%, rgba(239, 112, 47, .18), transparent 38%); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 9%; bottom: -34%; left: 9%; height: 46%; border: 1px solid rgba(255, 255, 255, .65); border-radius: 50%; background: linear-gradient(90deg, rgba(255, 184, 91, .26), rgba(255, 255, 255, .72), rgba(220, 63, 105, .18)); box-shadow: 0 -1rem 1.7rem rgba(255, 255, 255, .56); content: ''; filter: blur(1rem); pointer-events: none; }.glass-panel__edge { position: absolute; z-index: 1; inset: 6px; border: 1px solid rgba(255, 255, 255, .52); border-radius: calc(1.75rem - 6px); box-shadow: inset 0 1px 1px rgba(255, 255, 255, .66), inset 0 -1px 2px rgba(127, 59, 30, .12); pointer-events: none; }
