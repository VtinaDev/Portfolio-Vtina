...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(4rem, 12vw, 12rem)), 38rem); min-height: min(22rem, calc(100svh - 18rem)); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, 1); border-radius: clamp(1.8rem, 3vw, 2.7rem); outline: .32rem solid rgba(255, 255, 255, .52); outline-offset: .06rem; background: linear-gradient(145deg, rgba(255, 255, 255, .97), rgba(236, 241, 255, .68) 54%, rgba(248, 237, 248, .56)); box-shadow: inset 0 2px 1px rgba(255, 255, 255, 1), inset 0 -3px 2px rgba(92, 12, 72, .11), inset 1.25rem 1.45rem 2.8rem rgba(255, 255, 255, .86), inset -1.25rem -1.45rem 2.8rem rgba(92, 12, 72, .08), 0 .25rem .35rem rgba(255, 255, 255, 1), 0 .7rem 1rem rgba(118, 125, 181, .18), 0 1.7rem 3.2rem rgba(91, 25, 15, .14); backdrop-filter: blur(1.8rem) saturate(1.18); -webkit-backdrop-filter: blur(1.8rem) saturate(1.18); transform: perspective(80rem) rotateX(.25deg); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 18% -3%, rgba(255, 255, 255, 1) 0 15%, transparent 35%), radial-gradient(ellipse at 2% 48%, rgba(255, 255, 255, .84), transparent 27%), radial-gradient(ellipse at 94% 5%, rgba(176, 210, 255, .4), transparent 26%), linear-gradient(108deg, rgba(255, 255, 255, .82) 0 7%, rgba(255, 255, 255, .22) 18%, transparent 32% 69%, rgba(181, 209, 255, .3) 81%, rgba(255, 255, 255, .7) 100%); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 9%; bottom: -28%; left: 9%; height: 46%; border: 2px solid rgba(255, 255, 255, .74); border-radius: 50%; background: linear-gradient(90deg, rgba(147, 216, 255, .18), rgba(255, 255, 255, .7) 45%, rgba(194, 11, 90, .17)); box-shadow: 0 -1rem 1.6rem rgba(255, 255, 255, .58); content: ''; filter: blur(1.05rem); pointer-events: none; }
