...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(calc(100% - clamp(4rem, 12vw, 12rem)), 38rem); min-height: min(22rem, calc(100svh - 18rem)); align-self: center; justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, 1); border-radius: clamp(1.8rem, 3vw, 2.7rem); outline: .32rem solid rgba(255, 255, 255, .36); outline-offset: .06rem; background: linear-gradient(145deg, rgba(255, 255, 255, .94), rgba(244, 244, 249, .64) 58%, rgba(248, 240, 247, .5)); box-shadow: inset 0 1.5px 0 rgba(255, 255, 255, 1), inset 0 -2px 0 rgba(92, 12, 72, .08), inset 1.25rem 1.45rem 2.8rem rgba(255, 255, 255, .68), inset -1.25rem -1.45rem 2.8rem rgba(92, 12, 72, .06), 0 .35rem .45rem rgba(255, 255, 255, 1), 0 .75rem .9rem rgba(92, 12, 72, .1), 0 1.7rem 3.2rem rgba(91, 25, 15, .12); backdrop-filter: blur(1.8rem) saturate(1.1); -webkit-backdrop-filter: blur(1.8rem) saturate(1.1); transform: perspective(80rem) rotateX(.25deg); }.glass-panel::before { position: absolute; z-index: 0; inset: 0; border-radius: inherit; background: radial-gradient(ellipse at 16% 0%, rgba(255, 255, 255, 1), transparent 31%), radial-gradient(ellipse at 0% 48%, rgba(255, 255, 255, .58), transparent 22%), linear-gradient(112deg, rgba(255, 255, 255, .64), transparent 25%, transparent 72%, rgba(255, 255, 255, .2)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; z-index: 0; right: 18%; bottom: -31%; left: 18%; height: 38%; border: 1px solid rgba(255, 255, 255, .5); border-radius: 50%; background: linear-gradient(90deg, rgba(217, 74, 18, .07), rgba(194, 11, 90, .13), rgba(92, 12, 72, .08)); content: ''; filter: blur(1.3rem); pointer-events: none; }
