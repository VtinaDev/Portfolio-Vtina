...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(100%, 80rem); min-height: calc(100svh - 13rem); justify-self: center; background: transparent; }.glass-panel::before, .glass-panel::after { display: none; }
