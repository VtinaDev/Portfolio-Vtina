...
<style scoped>
:deep(.home-layout) { background: #6d1b45; }
:deep(.home-layout main) { padding: 0; background: #6d1b45; }
...
.home-hero { position: relative; display: grid; min-height: min(48rem, 100vh); grid-template-columns: minmax(0, 1fr); overflow: hidden; padding: clamp(5.8rem, 10vw, 8rem) clamp(1.25rem, 5vw, 4.5rem) clamp(2rem, 5vw, 4.5rem); background: radial-gradient(circle at 12% 13%, rgba(255, 196, 118, .96), transparent 29%), radial-gradient(circle at 88% 18%, rgba(247, 37, 133, .84), transparent 34%), radial-gradient(circle at 52% 92%, rgba(217, 74, 18, .84), transparent 42%), linear-gradient(135deg, #6d1b45 0%, #9f245c 45%, #d95a12 100%); color: var(--brand-ink); isolation: isolate; }
