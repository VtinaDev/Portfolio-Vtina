...
.glass-panel { position: relative; z-index: 1; display: grid; width: min(100%, 80rem); min-height: calc(100svh - 13rem); justify-self: center; overflow: hidden; border: 1px solid rgba(255, 255, 255, .74); border-radius: clamp(1.75rem, 3vw, 3rem); background: linear-gradient(135deg, rgba(255, 255, 255, .58), rgba(255, 255, 255, .14)); box-shadow: inset 0 1px 0 rgba(255, 255, 255, .92), inset 0 -1px 0 rgba(255, 255, 255, .26), inset 1.1rem 1.4rem 2.5rem rgba(255, 255, 255, .14), inset -1.1rem -1.4rem 2.5rem rgba(91, 25, 15, .1), 0 1.6rem 3.8rem rgba(91, 25, 15, .22); backdrop-filter: blur(1rem); -webkit-backdrop-filter: blur(1rem); }.glass-panel::before { position: absolute; inset: 0; background: linear-gradient(125deg, rgba(255, 255, 255, .42), transparent 28%, transparent 67%, rgba(255, 255, 255, .12)); content: ''; pointer-events: none; }.glass-panel::after { position: absolute; right: 8%; bottom: -28%; left: 8%; height: 32%; border-radius: 50%; background: rgba(92, 12, 72, .16); content: ''; filter: blur(2.4rem); pointer-events: none; }
...
.home-hero__actions .button--primary { background: linear-gradient(105deg, #f28b22, #d95a12 55%, #8b270e); }
.home-hero__actions .button--secondary { background: linear-gradient(105deg, #79163f, #c20b5a 55%, #f72585); }
